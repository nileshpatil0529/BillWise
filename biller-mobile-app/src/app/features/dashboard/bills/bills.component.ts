...
export class BillsComponent implements OnInit {
  ...
  ngAfterViewInit(): void {
    ...
    if (this.billsListContainer) {
      fromEvent(this.billsListContainer.nativeElement, 'scroll')
        .pipe(
          debounceTime(200),
  ...
  onScroll(): void {
    const element = this.billsListContainer.nativeElement;
