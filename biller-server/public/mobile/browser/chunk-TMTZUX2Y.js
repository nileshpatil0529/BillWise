...
`),t+=`
`,t+=c+"VA",t}buildKOTData(e,n,i){let r=C[i],o="\x1B",c="",u="-".repeat(r),g=n?.receiptLanguage==="hi",b=(e.items||[]).filter(a=>a.quantity>(a.kotPrintedQuantity||0)),t="";t+=o+"@",t+=o+"a"+o+"E"+c+"!",t+=`Kitchen Order
`,t+=c+"!\0"+o+`E\0
...
`,t+=c+"VA",t}rpad(e,n,i){let r=e.length+n.length,o=Math.max(1,i-r);return e+" ".repeat(o)+n}static \u0275fac=function(n){return new(n||l)};static \u0275prov=P({token:l,factory:l.\u0275fac,providedIn:"root"})};export{T as a};
